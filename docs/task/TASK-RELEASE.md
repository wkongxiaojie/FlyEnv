...
本次更新内容：
1. 彻底修复手动输入激活码时出现的 `[object Object]` 异常弹窗及 IPC 回调截断问题。
2. 在设置中新增一键“清除许可证”功能与二次防误触确认，便于测试与切换状态。
3. 增加主动停用状态保护机制，防止手动清除许可证后被后台自动恢复激活。
4. 将“请求许可证”一键定向至官方 GitHub Issues 提交页面，流程透明高效。
5. 优化主进程与 Fork 进程间的许可证与全局配置状态同步。
